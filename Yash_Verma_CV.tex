...
\resumeSubheading
{\href{https://gnome.org}{Gnome Foundation}}{United States of America}
...
\resumeItem{\href{https://github.com/yash10019coder/resume}{My-Resume}}{Personal Resume with seperate tracks and \textbf{cd pipeline} to automatically upload the new version of the resume to \textbf{Google Drive} and \textbf{Github} respectively.}
\resumeSubHeadingListEnd

...
\resumeSubHeadingListStart
\item{
            \textbf{Programming Languages}{: Java, Kotlin, Python, JavaScript, C, C++, SQL, bash, Golang}
      }
\item{
            \textbf{Technologies/Frameworks}{: Linux, AndroidSDK, Dagger/Hilt, Android Jetpack, NodeJS, Docker, Google Cloud, Github actions, CI/CD pipelines, Express, MongoDB, Realm, Git, MySQL, Firebase, Gradle, Bazel, JSON, Regex}
      }
\resumeSubHeadingListEnd

...
\newcommand{\resumeSubItem}[1]{\vspace{-2pt}\resumeItem{#1}\vspace{-13pt}}
...
\begin{itemize}[leftmargin=*, itemsep=1pt, parsep=0pt]
  ...
  \item \href{https://github.com/yash10019coder/resume}{\textbf{My Resume}}: \textbf{Automated deployment} of resume updates using \textbf{GitHub Actions} and \textbf{GCP} to \textbf{Google Drive}.

...
\resumeSubheading
{\href{https://0chain.net}{SDE 0chain}}{Cupertino, CA (Remote)}
{Software Development Engineer}{Feb 2022 -- Present}

\resumeItemListStart
% \begin{itemize}[]
\resumeItem {\textbf{Tech Stack}: \textbf{Kotlin, Java, Golang, AndroidSDK, NDK, GitHub Actions, Elastic Search, Gin, Grafana, Helm}.}
...
{Bachelor of Information Technology;  CGPA: 8.32}{2021}
